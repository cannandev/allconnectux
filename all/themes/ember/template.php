...
/**
 * Override hook_form_element.
 *
 * @param object $variables
 *   The form item we wish to edit output for.
 * @see https://api.drupal.org/api/drupal/includes%21form.inc/function/theme_form_element/7.x
 *
 * @return array
 *   An associative array containing the properties of the element. 
 */
// function ember_form_element($variables) {
//   $element = &$variables['element'];

//   // Rename N/A radio button. Set as default selected and last listed.
//   if ($element['#type'] == 'radio' && $element['#return_value'] === '_none') {
//     $variables['element']['#title'] = 'None';
//     $variables['element']['#default_value'] = TRUE;
//     $variables['element']['#delta'] = 1;
//   }   

//   // Copied from form.inc. Rearrange to display description between title and input.
//   $element += array(
