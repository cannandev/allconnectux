...
$databases = array (
  ...
  array (
    'default' => 
    array (
        'database' => 'dev_drupal_xfinityBrand',
        'username' => 'dev_acDrupal',
        'password' => '1allconnect1',
        'host' => 'msnpd000.east.aws.allconnect.com',      
      'port' => '',
      'driver' => 'mysql',
      'prefix' => 'swyyft_ac_',
    ),
 ...
 *
 */
$drupal_hash_salt = 'lungyoZIOyQegOEW0c900UHAylbGrf7MRdgubBDYOuQ';
 ...
 */
  ...
  if(strstr($_SERVER['SERVER_NAME'], "stg000") || strstr($_SERVER['SERVER_NAME'], "stg001") || strstr($_SERVER['SERVER_NAME'], "prd000") || strstr($_SERVER['SERVER_NAME'], "prd001")) {
